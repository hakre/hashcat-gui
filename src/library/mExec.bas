...
' * cExec accompagning global Module


' GetPriorityClass: http://msdn.microsoft.com/en-us/library/ms683211(VS.85).aspx
' SetPriorityClass
...
'
' shell and wait incl. optional timout
'
Public Function ShellandWait(ExeFullPath As String, Optional iWindowStyle As VbAppWinStyle = vbMinimizedNoFocus, Optional TimeOutValue As Long = 0) As Boolean
    ...
    lInst = Shell(sExeName, iWindowStyle)
